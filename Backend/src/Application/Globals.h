...
namespace Application
{
    ...
    public:
        ...
        Types::SecureMasterKey masterSecret = Types::SecureMasterKey(""); ///< Master secret for key derivation (should be set securely)
        ...
        std::string keycloakRedirectUri = "http://localhost/Controllers/Authentication/callback"; ///< Keycloak redirect URI
