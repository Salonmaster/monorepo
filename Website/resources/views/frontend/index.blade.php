                            ...
                            <div class="container px-5">
                                <div class="row gx-5 justify-content-center align-items-center">
                                    <div class="col-lg-6" data-aos="fade-right">
                                        <h1 class="page-header-ui-title">De app voor jouw salon!</h1>
                                        <p class="page-header-ui-text mb-5">Met Salonmaster is het managen van uw Salon zo geknipt.</p>
                                        <div class="mb-5 mb-lg-0">
                                            <a class="me-3" href="#!"><img src="assets/img/app-badges/app-store-badge.svg" style="height: 3rem" /></a>
                                            <a href="#!"><img src="assets/img/app-badges/google-play-badge.svg" style="height: 3rem" /></a>
                                    ...
                                    <div class="col-lg-6 z-1" data-aos="fade-left">
                                        <div class="device-wrapper mx-auto mb-n15">
                                            <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                                <div class="screen"><img class="img-fluid z-1" src="https://source.unsplash.com/eluzJSfkNCk/518x1122?fm=webp" /></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
